...
app.controller("appCtrl", ['$rootScope', '$scope', '$state', '$location','$window','loginService', 'Flash','appSettings',
function ($rootScope, $scope, $state, $location,$window, loginService, Flash,appSettings) {
    ...
    //console.log('storage ',JSON.parse(logindata).email)
